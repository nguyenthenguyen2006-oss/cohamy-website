...
Object.assign(tableLabels,{quotations:'Báo giá hiện hành',quotation_versions:'Phiên bản báo giá',quotation_events:'Lịch sử báo giá',quotation_pdfs:'PDF báo giá',organization_pricing:'Cấp giá nguồn',commercial_requests:'Yêu cầu mua hiện hành',sales_orders:'Đơn bán hiện hành',commercial_request_versions:'Phiên bản yêu cầu mua',sales_order_versions:'Phiên bản đơn bán',commercial_events:'Lịch sử yêu cầu và đơn',request_excel_previews:'Preview Excel nguồn',order_change_previews:'Preview sửa đơn'});
