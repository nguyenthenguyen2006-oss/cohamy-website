...
4. P4: pricing/quotes and the request/order core are implemented through migration017 with immutable price/address/policy snapshots and independent order/delivery/payment states. Configure real D04/D05 before activation; finish amendments, cancellation, partial delivery/backorder and stock-linked gifts.
