...
Updated 2026-09-18T20:12:47.965Z. Source HEAD 856b6a9a0ca17bad863fc6609a36ffe7951ccafb. LOCAL and isolated PostgreSQL STAGING evidence; candidate not released. Exactly 140 target IDs. 19 VERIFIED_LOCAL, 29 IN_PROGRESS, 92 NOT_STARTED; 0 RELEASED. This matrix is a status report, not a claim that 140 features work.
...
- Release / open work: uncommitted source based on 856b6a9a0ca17bad863fc6609a36ffe7951ccafb; LOCAL acceptance plus explicitly listed STAGING cases only; release pending.
...
- Release / open work: uncommitted source based on 856b6a9a0ca17bad863fc6609a36ffe7951ccafb; criteria above still require remaining behavior and full verification.
...
- Evidence: test-results/upgrade-browser-local.json; environment and test time are recorded per report.
- Release / open work: uncommitted source based on 856b6a9a0ca17bad863fc6609a36ffe7951ccafb; LOCAL acceptance plus explicitly listed STAGING cases only; release pending.
...
- Current behavior and gap: Scoped partners/SKU/website requests/tasks, result pagination. Commercial order search awaits P4; task search pagination still needs direct SQL filtering.
...
- Current behavior and gap: Immutable numbered files, version-specific read receipts and effective/expiry upload/display fields. Generic panel current-version indicator remains; library current-version acknowledgements verified separately.
- Dependencies / decisions: P0; permissions and organization scope; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Phase / status: P10 / IN_PROGRESS.
- UI / API / migration: operator CLI / systemd timer / backup-restore.ts; run-backup.py / all.
- Current behavior and gap: Consistent exported-snapshot dump, SHA256 of every row including bytea, independent restore of 49 tables and restored A/B/file-byte checks; guarded retention and daily timer source. Timer installation/production backup proof pending deploy.
...
- Evidence: test-results/backup-guards-local.json, test-results/public-files-backup-local.json, test-results/backup-restore-staging.json, test-results/restored-access-staging.json; environment and test time are recorded per report.
- Release / open work: uncommitted source based on 856b6a9a0ca17bad863fc6609a36ffe7951ccafb; criteria above still require remaining behavior and full verification.
