...
Updated 2026-09-18T19:19:43.460Z. Source HEAD 02746efe0aa502db71e8a18ec43537c09e382c3c. LOCAL evidence only; no release. Exactly 140 target IDs. 14 VERIFIED_LOCAL, 31 IN_PROGRESS, 95 NOT_STARTED; 0 RELEASED. This matrix is a status report, not a claim that 140 features work.
...
- Phase / status: P2 / VERIFIED_LOCAL.
...
- Evidence: test-results/upgrade-local.json, test-results/upgrade-browser-local.json; LOCAL 2026-09-18T19:19:43.460Z.
- Release / open work: uncommitted source based on 02746efe0aa502db71e8a18ec43537c09e382c3c; LOCAL acceptance only; staging/release pending.
...
- UI / API / migration: /crm/applications / onboarding/queue / 006.
- Current behavior and gap: Queue status/search/pagination, reviewer assignment/filter and minimum waiting hours. PostgreSQL competing reviewers NOT_RUN.
- Dependencies / decisions: P1 minimum; D01-D03; D13 for library policies; no external live verification assumed.
- Permission: Applicant-own profile until approval; reviewer ADMIN; active portal organization after approval.
- Acceptance: Lọc đăng ký mới, người phụ trách, thời gian chờ; xử lý đồng thời không duyệt hồ sơ hai lần
- Evidence: test-results/upgrade-local.json, test-results/partner-library-local.json, test-results/upgrade-browser-local.json; LOCAL 2026-09-18T19:19:43.460Z.
- Release / open work: uncommitted source based on 02746efe0aa502db71e8a18ec43537c09e382c3c; criteria above still require remaining behavior and full verification.
...
- Current behavior and gap: Atomic organization/membership/assignment/audit/notification. Exact approval retry fingerprint. PostgreSQL multi-connection gate NOT_RUN.
- Dependencies / decisions: P1 minimum; D01-D03; D13 for library policies; no external live verification assumed.
- Permission: Applicant-own profile until approval; reviewer ADMIN; active portal organization after approval.
...
- Evidence: test-results/partner-library-local.json, test-results/upgrade-browser-local.json; LOCAL 2026-09-18T19:19:43.460Z.
- Release / open work: uncommitted source based on 02746efe0aa502db71e8a18ec43537c09e382c3c; criteria above still require remaining behavior and full verification.
...
- Evidence: test-results/upgrade-browser-local.json; LOCAL 2026-09-18T19:19:43.460Z.
- Release / open work: uncommitted source based on 02746efe0aa502db71e8a18ec43537c09e382c3c; LOCAL acceptance only; staging/release pending.
...
- Phase / status: P4 / VERIFIED_LOCAL.
...
- Evidence: test-results/portal-services-local.json, test-results/upgrade-browser-local.json; LOCAL 2026-09-18T19:19:43.460Z.
- Release / open work: uncommitted source based on 02746efe0aa502db71e8a18ec43537c09e382c3c; LOCAL acceptance only; staging/release pending.
...
- Evidence: test-results/upgrade-local.json, test-results/portal-services-local.json, test-results/partner-library-local.json, test-results/upgrade-browser-local.json; LOCAL 2026-09-18T19:19:43.460Z.
- Release / open work: uncommitted source based on 02746efe0aa502db71e8a18ec43537c09e382c3c; criteria above still require remaining behavior and full verification.
...
- Current behavior and gap: Persistent support thread, statuses, scoped assignee selection and internal/private message separation; scoped PDF/photo attachments. PostgreSQL simultaneous retry NOT_RUN.
- Dependencies / decisions: P1 minimum; D01-D03; D13 for library policies; no external live verification assumed.
- Permission: Applicant-own profile until approval; reviewer ADMIN; active portal organization after approval.
...
- Current behavior and gap: Profile, contacts, website requests/notes/tasks/documents; quotations and commercial orders not implemented.
...
- Evidence: test-results/access-local.json, test-results/work-local.json, test-results/upgrade-browser-local.json; LOCAL 2026-09-18T19:19:43.460Z.
- Release / open work: uncommitted source based on 02746efe0aa502db71e8a18ec43537c09e382c3c; criteria above still require remaining behavior and full verification.

## F022 - Nhiều người liên hệ

- Phase / status: P3 / VERIFIED_LOCAL.
...
- Phase / status: P3 / IN_PROGRESS.
- UI / API / migration: partner detail / work duplicate suggestions / 003.
- Current behavior and gap: Existing scoped phone/email duplicate suggestions after creation. Input-time suggestion and business-ID normalization remain.
- Dependencies / decisions: P1; scoped organizations and work; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
- Acceptance: So sánh điện thoại/email/mã doanh nghiệp đã chuẩn hóa; cảnh báo không tiết lộ hồ sơ ngoài scope
- Evidence: test-results/access-local.json, test-results/work-local.json; LOCAL 2026-09-18T19:19:43.460Z.
- Release / open work: uncommitted source based on 02746efe0aa502db71e8a18ec43537c09e382c3c; criteria above still require remaining behavior and full verification.
...
- Evidence: test-results/relationships-local.json, test-results/upgrade-browser-local.json; LOCAL 2026-09-18T19:19:43.460Z.
- Release / open work: uncommitted source based on 02746efe0aa502db71e8a18ec43537c09e382c3c; LOCAL acceptance only; staging/release pending.
...
- Phase / status: P3 / IN_PROGRESS.
- UI / API / migration: /crm / work/orders,tasks / 003.
- Current behavior and gap: Existing work desk and scoped queues. Unified Today cutoff and per-role sections remain.
- Dependencies / decisions: P1; scoped organizations and work; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Current behavior and gap: Ordered checklist, persisted checkbox/title edits, version locking; incomplete checklist blocks completion. Drag reorder UI remains.
- Dependencies / decisions: P1; scoped organizations and work; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Current behavior and gap: Same-record scoped prerequisites, cycle detection, completion/reopen guards; PostgreSQL contention verification remains.
- Dependencies / decisions: P1; scoped organizations and work; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Phase / status: P2 / IN_PROGRESS.
- UI / API / migration: /crm/notifications; /portal/notifications / workspace/notifications,notification-read / 005.
- Current behavior and gap: Transactional in-app events; scoped list, links and read status. Read/unread filter remains.
- Dependencies / decisions: P1 minimum; D01-D03; D13 for library policies; no external live verification assumed.
- Permission: Applicant-own profile until approval; reviewer ADMIN; active portal organization after approval.
...
- Phase / status: P2 / IN_PROGRESS.
- UI / API / migration: /crm/workspace; /portal/workspace / workspace/preferences / 005.
- Current behavior and gap: Task notification opt-out is applied in transaction. Quiet-hour scheduling and channel/type preferences remain.
- Dependencies / decisions: P1 minimum; D01-D03; D13 for library policies; no external live verification assumed.
- Permission: Applicant-own profile until approval; reviewer ADMIN; active portal organization after approval.
...
- Current behavior and gap: Scoped partners/SKU/website requests/tasks, result pagination. Commercial order search awaits P4; task query currently scans scoped maximum 200.
...
- Phase / status: P1 / IN_PROGRESS.
- UI / API / migration: partner lists; /crm/workspace / workspace/filter,filters / 005.
- Current behavior and gap: Named private/shared filters with role validation; server always reapplies scope. Edit/default UI remains.
- Dependencies / decisions: P0; permissions and organization scope; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Phase / status: P1 / IN_PROGRESS.
- UI / API / migration: partner lists / workspace/preferences / 005.
- Current behavior and gap: Column visibility persisted per user and applied. Ordering and width customization remain.
- Dependencies / decisions: P0; permissions and organization scope; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Phase / status: P1 / VERIFIED_LOCAL.
...
- Current behavior and gap: XLSX mapping, row preview/errors, bounded ZIP, confirm-only write, durable job and unique row origins; actual Node restart verified on QA with fixture-expired lease. Supervised PostgreSQL worker restart NOT_RUN.
- Dependencies / decisions: P0; permissions and organization scope; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
- Acceptance: Kiểm tra loại file/kích thước/cột/trùng/lỗi; xác nhận mới ghi; job có tiến độ và báo cáo tác động
- Evidence: test-results/data-jobs-local.json, test-results/worker-restart-local.json, test-results/upgrade-browser-local.json; LOCAL 2026-09-18T19:19:43.460Z.
- Release / open work: uncommitted source based on 02746efe0aa502db71e8a18ec43537c09e382c3c; criteria above still require remaining behavior and full verification.
...
- Phase / status: P1 / IN_PROGRESS.
- UI / API / migration: partner/intake/support detail / documents; documents/:version / 005,008.
- Current behavior and gap: Private DB-backed files, PDF/PNG/JPEG magic/size validation, checksums and scoped download. Metadata search UI remains.
- Dependencies / decisions: P0; permissions and organization scope; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Phase / status: P1 / IN_PROGRESS.
- UI / API / migration: document panel / workspace/document-read / 005.
- Current behavior and gap: Immutable versions and version-bound acknowledgements; effective/expiry schema. Effective-date/version-choice UI remains.
- Dependencies / decisions: P0; permissions and organization scope; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Phase / status: P1 / IN_PROGRESS.
- UI / API / migration: /crm/accounts/:id / work/account / 001,003.
- Current behavior and gap: Existing server role/organization checks, revoke and role change. Human-readable permission matrix/affected-user preview remain.
- Dependencies / decisions: P0; permissions and organization scope; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Phase / status: P1 / IN_PROGRESS.
- UI / API / migration: /crm/profile; /portal/profile / workspace/sessions,session-revoke / 005.
- Current behavior and gap: Own session list, individual revocation, immediate invalidation. Device metadata and revoke-all-others action remain.
- Dependencies / decisions: P0; permissions and organization scope; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Phase / status: P1 / IN_PROGRESS.
- UI / API / migration: /crm/audit / workspace/audit / 001,005.
- Current behavior and gap: Admin-only actor/action/entity search, pagination, append-only. Date filters and field-level before/after view remain.
- Dependencies / decisions: P0; permissions and organization scope; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Phase / status: P10 / NOT_STARTED.
- UI / API / migration: Not implemented / none / none.
- Current behavior and gap: Not implemented. Independent DB/file restore, retention/RPO/RTO/location and release authorization required.
