...
Updated 2026-09-18T21:12:41.865Z. Source HEAD 9ca064d5a2487c50edb19958962cd9ebb1cf6318. Production code at 9ca064d5a2487c50edb19958962cd9ebb1cf6318; care migration012 cohort is newer source pending release. LOCAL and isolated PostgreSQL STAGING evidence are recorded separately. Exactly 140 target IDs. 20 RELEASED, 4 VERIFIED_STAGING, 2 VERIFIED_LOCAL, 27 IN_PROGRESS, 87 NOT_STARTED. This matrix is a status report, not a claim that 140 features work.
...
- Release / open work: Code deployed at 9ca064d5a2487c50edb19958962cd9ebb1cf6318; production metadata/HTTPS checks are read-only, live business/provider acceptance is not inferred.
...
- Release / open work: Current source based on 9ca064d5a2487c50edb19958962cd9ebb1cf6318; criteria above still require remaining behavior and verification.
...
- Phase / status: P3 / VERIFIED_STAGING.
...
- Evidence: test-results/care-automation-local.json, test-results/care-browser-local.json, test-results/care-automation-postgres.json, test-results/care-worker-postgres.json; environment and test time are recorded per report.
- Release / open work: Current source based on 9ca064d5a2487c50edb19958962cd9ebb1cf6318; listed LOCAL/STAGING acceptance; new care cohort release pending.
...
- Current behavior and gap: Consistent exported-snapshot dump, SHA256 of every row including bytea, independent restore of 49 tables and restored A/B/file-byte checks; guarded retention and daily timer source. Production timer active and first independently restored scheduled backup PASS at deployed SHA; retention defaults are disclosed, business RPO/RTO remains unagreed.
