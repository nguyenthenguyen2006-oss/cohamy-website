...
Updated 2026-09-19T00:29:08.343Z. Source HEAD c75bfcfabc37ac5e08c99ed2cb12ee2287a8fc9c. Production code at c75bfcfabc37ac5e08c99ed2cb12ee2287a8fc9c through migration017; source includes015-017 versioned pricing, quotation and commercial-order cohorts. Public mobile acceptance follows the separate production Edge report. LOCAL and isolated PostgreSQL STAGING evidence are recorded separately. Exactly 140 target IDs. 48 RELEASED, 0 VERIFIED_STAGING, 0 VERIFIED_LOCAL, 27 IN_PROGRESS, 65 NOT_STARTED. This matrix is a status report, not a claim that 140 features work.
...
- Release / open work: Code deployed at c75bfcfabc37ac5e08c99ed2cb12ee2287a8fc9c; production metadata/HTTPS checks are read-only, live business/provider acceptance is not inferred.
...
- Release / open work: Current source based on c75bfcfabc37ac5e08c99ed2cb12ee2287a8fc9c; criteria above still require remaining behavior and verification.
...
- Current behavior and gap: Profile/catalog/current-policy-read and first submitted commercial-request checklist use actual scoped records; acknowledgements follow latest effective document version.
- Dependencies / decisions: P1 minimum; D01-D03; D13 for library policies; no external live verification assumed.
- Permission: Applicant-own profile until approval; reviewer ADMIN; active portal organization after approval.
...
- UI / API / migration: /portal / commerce/dashboard; notifications / 017.
- Current behavior and gap: Dealer home uses current organization/user scope for actionable requests, recent orders and unread notifications. It never injects sample metrics into runtime.
...
- Phase / status: P4 / RELEASED.
- UI / API / migration: /portal/goods; /portal/requests/new; /crm/requests/new / commerce/save-request / 017.
- Current behavior and gap: Multi-line native SKU/unit/quantity entry validates active catalog units and current exact commercial pricing before an immutable draft version is saved.
- Dependencies / decisions: P2/P3; D03-D05; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- UI / API / migration: confirmed order detail -> reorder / commerce/save-request; reorder comparison / 017.
- Current behavior and gap: PARTIAL: copies historical lines into a new request and presents historical/current exact price before save. Supply availability remains CHECK_AT_RESERVATION until the inventory ledger is implemented.
- Dependencies / decisions: P2/P3; D03-D05; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Phase / status: P4 / RELEASED.
- UI / API / migration: /portal/requests/excel / commerce/excel-template,excel-preview,excel-confirm / 017.
- Current behavior and gap: Bounded XLSX template/mapping, per-row errors, formula/macro/encryption rejection, current unit/price checks and preview-only flow. Explicit confirmation atomically creates one unsent draft; no partial rows.
- Dependencies / decisions: P2/P3; D03-D05; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Current behavior and gap: Multiple saved addresses with one default and retained inactive history; confirmed orders freeze recipient/phone/address bytes so later address edits do not rewrite old orders.
- Dependencies / decisions: P2/P3; D03-D05; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Phase / status: P4 / RELEASED.
- UI / API / migration: request detail in portal / commerce/request-action,submit-request / 017.
- Current behavior and gap: Dealer staff proposal remains private until owner exact-version approval; edits invalidate approval. Only an explicit submit after current policy checks exposes the request to Cohamy.
- Dependencies / decisions: P2/P3; D03-D05; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Current behavior and gap: Profile, contacts, website requests/notes/tasks/documents, quotations and commercial request/order histories under current scope; stock/delivery/money ledgers remain pending.
...
- Phase / status: P4 / RELEASED.
- UI / API / migration: request/order detail / commerce/save-request,submit-request,order-action / 015,017.
- Current behavior and gap: Confirmation freezes exact price, unit versions, applied pricing source, order-policy version and delivery address in an immutable order version. Later price/address changes do not rewrite it.
- Dependencies / decisions: P2/P3; D03-D05; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Phase / status: P4 / RELEASED.
- UI / API / migration: request/order detail / commerce/submit-request,order-action / 017.
- Current behavior and gap: Policy-gated conversion retains request/accepted-quote source and uses exact idempotency. Injected SQL failure rolls back the complete order/version/event transition.
- Dependencies / decisions: P2/P3; D03-D05; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Phase / status: P4 / RELEASED.
- UI / API / migration: /crm/requests/new; /crm/sales/:id / commerce/save-request,submit-request / 017.
- Current behavior and gap: Scoped internal staff chooses a current partner and records actor plus PHONE/MEETING/OTHER source while the same price, approval and partner-field rules apply.
- Dependencies / decisions: P2/P3; D03-D05; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Phase / status: P4 / RELEASED.
- UI / API / migration: /crm/orders/policy; order detail / commerce/order-policy,order-action / 017.
- Current behavior and gap: Manager-only immutable routing versions cover amount, special price, terms and required partner fields. Exceptions require the configured different approver with reason before confirmation. No real D05 policy is enabled by default.
- Dependencies / decisions: P2/P3; D03-D05; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Phase / status: P4 / RELEASED.
- UI / API / migration: order detail / commerce/order-action / 017.
- Current behavior and gap: Order, delivery and payment statuses are separate immutable snapshot fields. Confirming a sales order does not mark delivery or create receivable/payment entries.
- Dependencies / decisions: P2/P3; D03-D05; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Phase / status: P4 / RELEASED.
- UI / API / migration: request/order detail / commerce/request-events,order-events / 017.
- Current behavior and gap: Immutable actor/time/action/reason timeline exposes public events to the dealer while internal approval reasons remain Cohamy-only.
- Dependencies / decisions: P2/P3; D03-D05; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
...
- Phase / status: P4 / RELEASED.
- UI / API / migration: request detail / commerce/duplicates / 017.
- Current behavior and gap: Current-scope warning compares partner, converted lines and time window separately from idempotency; candidates remain reviewable and no valid order is deleted automatically.
- Dependencies / decisions: P2/P3; D03-D05; no external live verification assumed.
- Permission: Server role and current organization/assignment scope; jobs and downloads revalidate.
